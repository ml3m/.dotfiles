...
alias cpconf="rsync -av --progress ~/.config/ ~/github_backup/configs --exclude obsidian --exclude .git --exclude VisUAL2 --exclude /Code\ -\ OSS --exclude dconf --exclude discord --exclude gtk-3.0 --exclude BraveSoftware"
